#
# Challenge game in python lang where I should solve all the 33 levels
#
import re
# 2 in power of 38
poweredNumberLevel1 = 2**38
print(poweredNumberLevel1)

# now we have to decrypt message
messageLevel2 = "g fmnc wms bgblr rpylqjyrc gr zw fylb. rfyrq ufyr amknsrcpq ypc dmp. bmgle gr gl zw fylb gq glcddgagclr ylb rfyr'q ufw rfgq rcvr gq qm jmle. sqgle qrpgle.kyicrpylq() gq pcamkkclbcb. lmu ynnjw ml rfc spj."
alphabet1 = "abcdefghijklmnopqrstuvwxyz"
encryptedMessage = ""
for letter in messageLevel2:
    index = alphabet1.find(letter)
if index >= 0:
    encryptedMessage += alphabet1[(index + 2) % len(alphabet1)]
else:
    encryptedMessage
print(encryptedMessage)

#need to find rare used symbols
messageLevel3 = """ % %$@_
...
{*!  # %[[#]!](^^$![#[[*}%(_#^^!%))!_^@)@**@}}(%%{#*%@(((]^%^![&
    ...
    # @}&$[[%]_&$+)$!%{(}$^$}* """
rareSymbolsLevel3 =[letter for letter in messageLevel3 if letter.islower()]
print(sorted(rareSymbolsLevel3, reverse=True))

#to find letter
messageLevel4 = """kAewtloYgcFQaJNhHVGxXDiQmzjfcpYbzxlWrVcqsmUbCunkfxZWDZjUZMiGqhRRiUvGmYmvnJIHEmbT
...
encryptedMessageLevel4 = str(re.findall("[^A-Z]+[A-Z]{3}([a-z])[A-Z]{3}[^A-Z]+", messageLevel4))
print(encryptedMessageLevel4)